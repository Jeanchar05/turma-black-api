...
(() => {
  ...
  function release(user) {
    ...
    document.dispatchEvent(new CustomEvent("turma:exams-ready", {
      detail: { user }
    }));
  }
  ...
  // Libera visualmente a página assim que o DOM estiver disponível,
  // antes mesmo de a autenticação terminar.
