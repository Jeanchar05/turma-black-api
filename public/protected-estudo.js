...
(() => {
  ...
  function installAssets(){
    load("/study-mobile-v2.css?v=20260812-shell-v24","style","studyMobilePolish");
    load("/study-icon-fix.css?v=20260812-shell-v24","style","studyIconFix");
    load("/theme-global-v2.css?v=20260812-shell-v24","style","globalThemeCss");
    load("/student-shell-v23.css?v=20260812-shell-v24","style","studentShellCss");
    load("/theme-global-v2.js?v=20260812-shell-v24","script","globalThemeLoader");
    load("/platform-final.css?v=20260812-shell-v24","style","platformFinalCss");
    load("/navigation-final.js?v=20260812-shell-v24","script","navigationFinalJs");
    load("/student-shell-v23.js?v=20260812-shell-v24","script","studentShellJs");
    const route=location.pathname.replace(/\/$/,"")||"/";
    if(route==="/estudo"||route==="/estudo.html"||route.startsWith("/estudo-"))load("/study-images-final.js?v=20260812-study-v24","script","studyImagesFinalJs");
    if(route.startsWith("/estudo-")&&route!=="/estudo.html"){
      load("/race-tool.css?v=20260812-race-v4-1","style","raceToolCss");
      load("/race-mobile-v23.css?v=20260812-race-v4-1","style","raceMobileV23");
      load("/race-tool.js?v=20260812-race-v4-1","script","raceToolJs");
      load("/study-race-injector.js?v=20260812-race-v4-1","script","studyRaceInjectorJs");
    }
    if(route==="/modulos"||route==="/modulos.html"){
      load("/modules-images-v23.css?v=20260812-modules-v24","style","modulesImagesCssV23");
      load("/modules-images-v23.js?v=20260812-modules-v24","script","modulesImagesV23");
    }
  }
