"use strict";
(() => {
  if(window.__TURMA_THEME_GLOBAL_V8__)return;window.__TURMA_THEME_GLOBAL_V8__=true;
  ...
  function install(){
    load("/theme-global-v2.css?v=20260803-v8","style","globalThemeCss");
    ...
    load("/notifications-button-v7.js?v=20260803-v8","script","notificationsButtonV7Js");
    load("/turma-overhaul-v8.js?v=20260803-v8","script","turmaOverhaulV8Js");
    const route=location.pathname.replace(/\/$/,"")||"/";
    if(route==="/estudo"||route==="/estudo.html"||route.startsWith("/estudo-"))load("/study-images-final.js?v=20260803-v8","script","studyImagesFinalJs");
    if(document.body?.classList.contains("student-dashboard")&&document.querySelector(".dash-hero")){load("/dashboard-final.css?v=20260803-v8","style","dashboardFinalCss");load("/dashboard-final.js?v=20260803-v8","script","dashboardFinalJs")}
  }
