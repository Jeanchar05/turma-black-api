...
(() => {
  ...
  function dashboardRecovery(){if(!document.body?.classList.contains("student-dashboard")||!document.querySelector(".dash-hero")||document.querySelector('script[data-dashboard-recovery]'))return;const script=document.createElement("script");script.src="/dashboard-controls-hotfix.js?v=20260802-controls-recovery-3";script.defer=true;script.dataset.dashboardRecovery="1";document.head.appendChild(script)}
  ...
  apply(saved(),false);
  const start=()=>{bind();dashboardRecovery();};
