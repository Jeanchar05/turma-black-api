...
(() => {
  ...
  function install(){
    load("/theme-global-v2.css?v=20260803-v9","style","globalThemeCss");
    load("/platform-final.css?v=20260803-v9","style","platformFinalCss");
    load("/platform-upgrade-v6.css?v=20260803-v9","style","platformUpgradeV6Css");
    load("/turma-overhaul-v8.css?v=20260803-v9","style","turmaOverhaulV8Css");
    load("/turma-overhaul-v8-addons.css?v=20260803-v9","style","turmaOverhaulV8AddonsCss");
    load("/site-stabilization-v9.css?v=20260803-v9","style","siteStabilizationV9Css");
    load("/platform-final.js?v=20260803-v9","script","platformFinalJs");
    load("/navigation-final.js?v=20260803-v9","script","navigationFinalJs");
    load("/platform-upgrade-v6.js?v=20260803-v9","script","platformUpgradeV6Js");
    load("/notifications-button-v7.js?v=20260803-v9","script","notificationsButtonV7Js");
    load("/turma-overhaul-v8.js?v=20260803-v9","script","turmaOverhaulV8Js");
    const route=location.pathname.replace(/\/$/,"")||"/";
    if(route==="/estudo"||route==="/estudo.html"||route.startsWith("/estudo-"))load("/study-images-final.js?v=20260803-v9","script","studyImagesFinalJs");
    if(document.body?.classList.contains("student-dashboard")&&document.querySelector(".dash-hero")){load("/dashboard-final.css?v=20260803-v9","style","dashboardFinalCss");load("/dashboard-final.js?v=20260803-v9","script","dashboardFinalJs")}
    load("/site-stabilization-v9.js?v=20260803-v9","script","siteStabilizationV9Js");
  }
