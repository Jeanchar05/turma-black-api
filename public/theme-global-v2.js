...
(() => {
  ...
  function install(){load("/theme-global-v2.css?v=20260802-global-theme","style","globalThemeCss");load("/platform-final.css?v=20260802-final-1","style","platformFinalCss");load("/platform-final.js?v=20260802-final-1","script","platformFinalJs");load("/navigation-final.js?v=20260802-navigation-final","script","navigationFinalJs");if(document.body?.classList.contains("student-dashboard")&&document.querySelector(".dash-hero")){load("/dashboard-final.css?v=20260802-final-2","style","dashboardFinalCss");load("/dashboard-final.js?v=20260802-final-2","script","dashboardFinalJs");load("/dashboard-notifications-final.js?v=20260802-final-1","script","dashboardNotificationsFinal")}}
  apply(saved(),false);
